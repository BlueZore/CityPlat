...
public class SocketHttpRequester {
	...
	public static boolean post(String path, Map<String, String> params,
		...
		String accept = "Accept: application/x-msdownload, application/zip, image/gif, image/jpeg, image/pjpeg, image/pjpeg, application/x-shockwave-flash, application/xaml+xml, application/vnd.ms-xpsdocument, application/x-ms-xbap, application/x-ms-application, application/vnd.ms-excel, application/vnd.ms-powerpoint, application/msword, */*\r\n";
